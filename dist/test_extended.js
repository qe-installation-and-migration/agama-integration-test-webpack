...
exports.verifyAppearanceChanges = verifyAppearanceChanges;
...
function verifyAppearanceChanges() {
    (0, helpers_1.it)("should cycle through color scheme and contrast combinations and return to the initial state", async function () {
        const appearance = new appearance_page_1.AppearancePage(helpers_1.page);
        await appearance.open();
        strict_1.default.ok(await appearance.isColorSchemeSelected("Automatic"));
        strict_1.default.ok(await appearance.isContrastSelected("Automatic"));
        await appearance.selectContrast("High");
        strict_1.default.ok(await appearance.isContrastSelected("High"));
        strict_1.default.ok((await appearance.themeClasses()).includes("pf-v6-theme-high-contrast"));
        await appearance.selectColorScheme("Light");
        await appearance.selectContrast("Automatic");
        strict_1.default.ok(await appearance.isColorSchemeSelected("Light"));
        strict_1.default.ok(await appearance.isContrastSelected("Automatic"));
        strict_1.default.ok(!(await appearance.themeClasses()).includes("pf-v6-theme-dark"));
        await appearance.selectContrast("High");
        strict_1.default.ok(await appearance.isColorSchemeSelected("Light"));
        strict_1.default.ok(await appearance.isContrastSelected("High"));
        strict_1.default.deepEqual(await appearance.themeClasses(), ["pf-v6-theme-high-contrast"]);
        await appearance.selectColorScheme("Dark");
        await appearance.selectContrast("Automatic");
        strict_1.default.ok(await appearance.isColorSchemeSelected("Dark"));
        strict_1.default.ok(await appearance.isContrastSelected("Automatic"));
        strict_1.default.ok((await appearance.themeClasses()).includes("pf-v6-theme-dark"));
        await appearance.selectContrast("High");
        strict_1.default.ok(await appearance.isColorSchemeSelected("Dark"));
...
/***/ "./src/checks/show_configuration.ts"
/*!******************************************!*\
  !*** ./src/checks/show_configuration.ts ***!
  \******************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.showAgamaConfiguration = showAgamaConfiguration;
exports.downloadJsonConfiguration = downloadJsonConfiguration;
const helpers_1 = __webpack_require__(/*! ../lib/helpers */ "./src/lib/helpers.ts");
const overview_page_1 = __webpack_require__(/*! ../pages/overview_page */ "./src/pages/overview_page.ts");
const options_toggle_page_1 = __webpack_require__(/*! ../pages/options_toggle_page */ "./src/pages/options_toggle_page.ts");
const installation_json_page_1 = __webpack_require__(/*! ../pages/installation_json_page */ "./src/pages/installation_json_page.ts");
const fs_1 = __importDefault(__webpack_require__(/*! fs */ "fs"));
const path_1 = __importDefault(__webpack_require__(/*! path */ "path"));
const strict_1 = __importDefault(__webpack_require__(/*! node:assert/strict */ "node:assert/strict"));
function showAgamaConfiguration() {
    (0, helpers_1.it)("should show json configuration", async function () {
        const overview = new overview_page_1.OverviewPage(helpers_1.page);
        const agamaConfiguration = new options_toggle_page_1.OptionsTogglePage(helpers_1.page);
        const installationPage = new installation_json_page_1.InstallationJsonPage(helpers_1.page);
        ...
        (0, strict_1.default)(content.trim().length > 0, "The displayed configuration is empty.");
    });
}
async function downloadJsonConfiguration() {
    (0, helpers_1.it)("should download json file", async function () {
        const downloadFolder = "/root/Downloads";
        const installationPage = new installation_json_page_1.InstallationJsonPage(helpers_1.page);
        ...
        const exactFilePath = path_1.default.join(downloadFolder, downloadedFiles[0]);
        const fileSize = fs_1.default.statSync(exactFilePath).size;
        (0, strict_1.default)(fileSize > 0, "Agama json file is empty.");
...
class AppearancePage {
    page;
    appearanceButton = () => this.page.locator('::-p-aria(Appearance[role="button"])');
    colorSchemeOption = (scheme) => this.page.locator(`::-p-aria(${scheme} color scheme[role='button'])`);
    contrastButton = (contrast) => this.page.locator(`::-p-aria(${contrast} contrast[role='button'])`);
    constructor(page) {
        this.page = page;
    }
    async open() {
...
/***/ "./src/pages/installation_json_page.ts"
/*!*********************************************!*\
  !*** ./src/pages/installation_json_page.ts ***!
  \*********************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.InstallationJsonPage = void 0;
const helpers_1 = __webpack_require__(/*! ../lib/helpers */ "./src/lib/helpers.ts");
class InstallationJsonPage {
    page;
    downloadJsonButton = () => this.page.locator('aria/Download configuration[role="button"]');
    closeButton = () => this.page.locator('aria/[role="contentinfo"]');
    jsonEditor = () => this.page.locator('::-p-aria([role="textbox"])');
    jsonContent = () => this.page.locator(".view-lines");
    constructor(page) {
        this.page = page;
    }
    ...
    async ensureJsonVisible(timeout = 30 * 1000) {
        await this.jsonEditor().setTimeout(timeout).wait();
    }
    async readJsonContent(timeout = 30 * 1000) {
        await this.ensureJsonVisible(timeout);
        const jsonContent = await (0, helpers_1.getTextContent)(this.jsonContent(), timeout);
        return jsonContent.replace(/ /g, " ");
    }
}
exports.InstallationJsonPage = InstallationJsonPage;
...
class OptionsTogglePage {
    ...
    showConfigurationButton = () => this.page.locator('::-p-aria(Show configuration[role="button"])');
    ...
    async showConfiguration() {
        const showConfig = await Promise.any([
            this.showConfigurationButton().waitHandle(),
        ]);
...
const show_configuration_1 = __webpack_require__(/*! ./checks/show_configuration */ "./src/checks/show_configuration.ts");
const show_configuration_2 = __webpack_require__(/*! ./checks/show_configuration */ "./src/checks/show_configuration.ts");
...
(0, show_configuration_1.showAgamaConfiguration)();
(0, show_configuration_2.downloadJsonConfiguration)();
...
class ProductionReleaseStrategy {
    ...
    verifyAppearanceChanges() {
        (0, appearance_1.verifyAppearanceChanges)();
    }
}
