...
function readTable() {
    (0, helpers_1.it)("should read result table", async function () {
        ...
        console.log(await (0, table_1.getTextInCell)(helpers_1.page, storageResult.resultTableSelector, "Device", "vda1", "Details"));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getTextInCell = getTextInCell;
...
async function readCell(page, tableSelector, row, column) {
    const columnIndex = await getColumnIndex(page, tableSelector, column);
    const cellText = await row.$eval(`*:nth-child(${columnIndex + 1})`, (cell) => cell.innerText);
    return cellText;
}
...
async function getTextInCell(page, tableSelector, rowColumn, rowValue, targetColumn) {
